...
import com.launch.setting.VotreAdresseFragment;
...
public class ReglagesProfileAddressFragment extends Fragment implements LocationListener,
OnClickListener, OnCheckedChangeListener{
	public static ReglagesProfileAddressFragment fragment;
	...
	public static ReglagesProfileAddressFragment getInstance() {
		if (fragment == null) {
			fragment = new ReglagesProfileAddressFragment();
			Bundle bundle = new Bundle();
			bundle.putString("Title", "R�glagess Mon Profil Votre adresse");
			bundle.putInt("bgColor", 0xff091302);
			bundle.putInt("ImageId", R.drawable.adresse);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		containerView = inflater.inflate(R.layout.reglages_profil_address_ui, container, false);
		containerView.findViewById(R.id.btnBack).setOnClickListener(UserApplication.getInstance().getActivity());
		
		rue = (EditText) containerView.findViewById(R.id.rue);
		ville = (EditText) containerView.findViewById(R.id.ville);
		pay = (EditText) containerView.findViewById(R.id.pays);
		update = (Button) containerView.findViewById(R.id.update);
		update.setOnClickListener(this);
		toggle = (SwitchButton) containerView.findViewById(R.id.toggle);
			...
			public void run() {
				...
				try {
					...
					if (response.getStatusLine().getStatusCode() == 200) {
						...
						lm.removeUpdates(ReglagesProfileAddressFragment.this);
					}
