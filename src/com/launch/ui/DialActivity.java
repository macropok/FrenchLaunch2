...
public class DialActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dial_ui);
	...
	public void Get_Id(){
		input_number_btn=(EditText) findViewById(R.id.input_number_btn);
		clear_btn=(ImageView) findViewById(R.id.clear_btn);
		
		one_txt=(TextView) findViewById(R.id.one_txt);
		two_txt=(TextView) findViewById(R.id.two_txt);
		three_txt=(TextView) findViewById(R.id.three_txt);
		four_txt=(TextView) findViewById(R.id.four_txt);
		
		five_txt=(TextView) findViewById(R.id.five_txt);
		six_txt=(TextView) findViewById(R.id.six_txt);
		seven_txt=(TextView) findViewById(R.id.seven_txt);
		eight_txt=(TextView) findViewById(R.id.eight_txt);
		
		nine_txt=(TextView) findViewById(R.id.nine_txt);
		star_txt=(TextView) findViewById(R.id.star_txt);
		zero_txt=(TextView) findViewById(R.id.zero_txt);
		hash_txt=(TextView) findViewById(R.id.hash_txt);
	}
	...
	public void get_Linear_views(){
		...
		linear_three=(LinearLayout) findViewById(R.id.linear_three);
		linear_four=(LinearLayout) findViewById(R.id.linear_four);
		
		linear_five=(LinearLayout) findViewById(R.id.linear_five);
		linear_six=(LinearLayout) findViewById(R.id.linear_six);
		...
		linear_star=(LinearLayout) findViewById(R.id.linear_star);
		linear_zero=(LinearLayout) findViewById(R.id.linear_zero);
		linear_hash=(LinearLayout) findViewById(R.id.linear_hash);
